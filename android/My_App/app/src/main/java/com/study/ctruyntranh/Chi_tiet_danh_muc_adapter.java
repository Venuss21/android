...
//public class Chi_tiet_danh_muc_adapter {
//}
...
public class Chi_tiet_danh_muc_adapter extends BaseAdapter {

    private Context context;
    private int layout;
    private List<TruyenTranhTC> truyenTranhTCList;

    public Chi_tiet_danh_muc_adapter(Context context, int layout, List<TruyenTranhTC> truyenTranhTCList) {
